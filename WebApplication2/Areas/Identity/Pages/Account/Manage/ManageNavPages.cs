...
namespace AdvertisingAgency.Web.Areas.Identity.Pages.Account.Manage
{
    public static class ManageNavPages
    {
        ...
        // Add the methods for the new pages
        public static string FriendlyNameNavClass(ViewContext viewContext) => PageNavClass(viewContext, FriendlyName);
        public static string PersonImageModelNavClass(ViewContext viewContext) => PageNavClass(viewContext, PersonImage);
